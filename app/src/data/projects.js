...
const allProjects = [
  ...
  },
  {
    ...
    description:
      'Portal inmobiliario con backend e infraestructura propios: catálogo con búsqueda y filtros, fichas con galería y un panel de administración donde la agencia gestiona los inmuebles y sube fotos que se optimizan solas a WebP y aparecen al instante. Migrado de WordPress a un stack propio (Next.js + PostgreSQL) autoalojado en VPS, sin comisiones ni dependencias de terceros. Cliente real en producción.',
    highlights: [
      'Backend e infraestructura propios',
      'Panel para gestionar inmuebles',
      'Fotos auto-optimizadas a WebP',
      'Búsqueda + filtros avanzados',
    ],
    tech: ['Next.js 15', 'PostgreSQL', 'Prisma', 'WebP'],
    accent: '#F59E0B',
    buttonText: 'Ver caso de estudio',
    href: '/proyectos/inmobiliaria-marina-carranque',
